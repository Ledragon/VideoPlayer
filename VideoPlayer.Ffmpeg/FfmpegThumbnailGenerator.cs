...
namespace VideoPlayer.Ffmpeg
{
  public class FfmpegThumbnailGenerator : IFfmpegThumbnailGenerator
  {
    ...
    public List<String> GenerateThumbnails(String videoFilePath, Int32 count, Int32 width = 640)
    {
      try
      {
        ...
        if (File.Exists(videoFilePath))
        {
          ...
          if (!String.IsNullOrEmpty(outputDir))
          {
            ...
            process.StartInfo.ArgumentList.Add($"fps=1/{fps.ToString(CultureInfo.InvariantCulture)},scale={width}:-1");
