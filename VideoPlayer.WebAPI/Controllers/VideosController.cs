...
namespace VideoPlayer.WebAPI.Controllers
{
  ...
  public class VideosController : ControllerBase
  {
    ...
    private readonly IFfprobeInfoExtractor _infoExtractor;
    ...
    public VideosController(ILogger<VideosController> logger,
        ...
        IFfprobeInfoExtractor infoExtractor)
    {
      this._logger = logger;
      ...
      this._infoExtractor = infoExtractor;
    ...
    [HttpGet("/api/videos/metadata")]
    public FfprobeVideoInfo GetMetaData([FromQuery] Int32 id)
    {
      var videos = this._videoRepository.Get(id);
      var info = this._infoExtractor.GetVideoInfo(videos.FileName);
      return info;
    }
  }
}
